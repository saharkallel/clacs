...
import GCLACS.diagram.edit.policies.ComponentInstanceItemSemanticEditPolicy;
...
public class ComponentInstanceEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ComponentInstanceDefineByDescriptorEditPart) {
			((ComponentInstanceDefineByDescriptorEditPart) childEditPart)
					.setLabel(getPrimaryShape()
