...
import GCLACS.diagram.edit.policies.RequiredPort2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class RequiredPort2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public RequiredPort2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
					...
					public Command getCommand(Request request) {
						if (understandsRequest(request)) {
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == GclacsElementTypes.BodyType_2003) {
									EditPart compartmentEditPart = getChildBySemanticHint(GclacsVisualIDRegistry
											.getType(ServicesBodyArgsCompartimentsEditPart.VISUAL_ID));
									return compartmentEditPart == null ? null
											: compartmentEditPart
													.getCommand(request);
								}
								if (type == GclacsElementTypes.Arg_2004) {
									EditPart compartmentEditPart = getChildBySemanticHint(GclacsVisualIDRegistry
											.getType(ServicesBodyArgsCompartimentsEditPart.VISUAL_ID));
									return compartmentEditPart == null ? null
											: compartmentEditPart
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RequiredPort2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ServicesNameEditPart) {
			((ServicesNameEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(GclacsVisualIDRegistry
				.getType(ServicesNameEditPart.VISUAL_ID));
	}
