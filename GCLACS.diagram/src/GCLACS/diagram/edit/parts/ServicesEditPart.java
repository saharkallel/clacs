...
import GCLACS.diagram.edit.policies.ServicesItemSemanticEditPolicy;
import GCLACS.diagram.part.GclacsVisualIDRegistry;

/**
 * @generated
 */
public class ServicesEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ServicesItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ComponentInstanceName2EditPart) {
			((ComponentInstanceName2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureComponentInstanceNameFigure());
			return true;
		}
		if (childEditPart instanceof ComponentInstanceDefineByDescriptor2EditPart) {
			((ComponentInstanceDefineByDescriptor2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureDescriptorComponentName());
			return true;
		}
		return false;
	}
	...
	public class ComponentInstanceFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureComponentInstanceNameFigure
					.setText("UnnamedComponentInstance");
