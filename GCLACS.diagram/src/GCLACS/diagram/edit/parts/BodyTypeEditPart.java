...
import GCLACS.diagram.edit.policies.BodyTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class BodyTypeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public BodyTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new BodyTypeItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		RequiredPortFigure figure = new RequiredPortFigure();
	 ...
	 * @generated
	 */
	public RequiredPortFigure getPrimaryShape() {
		return (RequiredPortFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RequiredPortNameEditPart) {
			((RequiredPortNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureRequiredPortName());
			return true;
		}
		return false;
	}
