...
import GCLACS.diagram.edit.policies.ComponentInstance2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ComponentInstance2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ComponentInstance2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		ProvidedPortFigure figure = new ProvidedPortFigure();
	 ...
	 * @generated
	 */
	public ProvidedPortFigure getPrimaryShape() {
		return (ProvidedPortFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ProvidedPortNameEditPart) {
			((ProvidedPortNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureProvidedPortName());
			return true;
		}
		return false;
	}
