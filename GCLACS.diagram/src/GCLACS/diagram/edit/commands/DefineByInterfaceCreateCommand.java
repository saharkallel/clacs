 ...
 * @generated
 */
public class DefineByInterfaceCreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public DefineByInterfaceCreateCommand(CreateRelationshipRequest request,
			EObject source, EObject target) {
		super(request);
		this.source = source;
		this.target = target;
		if (request.getContainmentFeature() == null) {
			setContainmentFeature(GCLACSPackage.eINSTANCE
					.getPort_DefineByInterface());
		}
	...
	public boolean canExecute() {
		...
		return GclacsBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateDefineByInterface_3001(getContainer(), getSource(),
						getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		DefineByInterface newElement = GCLACSFactory.eINSTANCE
				.createDefineByInterface();
		getContainer().setDefineByInterface(newElement);
		newElement.setPort(getSource());
		newElement.setInterface(getTarget());
		return newElement;
	}
	...
	protected EClass getEClassToEdit() {
		return GCLACSPackage.eINSTANCE.getPort();
	}
