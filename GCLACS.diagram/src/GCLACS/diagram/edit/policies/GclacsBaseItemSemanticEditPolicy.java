...
import GCLACS.Port;
import GCLACS.diagram.edit.helpers.GclacsBaseEditHelper;
import GCLACS.diagram.part.GclacsVisualIDRegistry;

/**
 * @generated
 */
public class GclacsBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(GclacsVisualIDRegistry
		...
		if (elementType != null) {
			if (semanticCommand != null) {
				...
				completedRequest.setParameter(
						GclacsBaseEditHelper.EDIT_POLICY_COMMAND, command);
			}
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateDefineByInterface_3001(Port container,
				Port source, Interface target) {
			if (container != null) {
				if (container.getDefineByInterface() != null) {
					return false;
				}
			}
			return canExistDefineByInterface_3001(container, source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreateBinding_3002(
				ComponentInstance container, Port source, Port target) {
			return canExistBinding_3002(container, source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canExistDefineByInterface_3001(Port container,
				Port source, Interface target) {
		 ...
		 * @generated
		 */
		public static boolean canExistBinding_3002(ComponentInstance container,
