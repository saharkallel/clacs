 ...
 * @generated
 */
public class GclacsDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public GclacsDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof GclacsDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier
					.getChildren(((GclacsDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new GclacsDomainNavigatorItem((EObject) objects[i],
