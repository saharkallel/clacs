 ...
 * <!-- end-user-doc -->
 * @see GCLACS.GCLACSPackage#getServiceKind()
 * @model
 * @generated
 */
public enum ServiceKind implements Enumerator {
	 ...
	 * @ordered
	 */
	CONSTRAINT_CHECK(0, "constraintCheck", "constraintCheck"),
	 ...
	 * @ordered
	 */
	CONTRACT_CHECK(0, "contractCheck", "contractCheck");
	 ...
	 * @ordered
	 */
	public static final int CONSTRAINT_CHECK_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int CONTRACT_CHECK_VALUE = 0;
