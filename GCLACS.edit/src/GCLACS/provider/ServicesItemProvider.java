...
/**
 * This is the item provider adapter for a {@link GCLACS.Services} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServicesItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Services_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Services_name_feature", "_UI_Services_type"),
				 GCLACSPackage.Literals.SERVICES__NAME,
				 true,
				 false,
				 false,
	...
	protected void addKindPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Services_kind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Services_kind_feature", "_UI_Services_type"),
				 GCLACSPackage.Literals.SERVICES__KIND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GCLACSPackage.Literals.SERVICES__ARG);
			childrenFeatures.add(GCLACSPackage.Literals.SERVICES__BODY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GCLACSPackage.Literals.SERVICES__ARG,
				 GCLACSFactory.eINSTANCE.createArg()));

		newChildDescriptors.add
			(createChildParameter
				(GCLACSPackage.Literals.SERVICES__BODY,
				 GCLACSFactory.eINSTANCE.createBodyType()));
	}
