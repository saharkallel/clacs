...
/**
 * This is the item provider adapter for a {@link metamodele.clacs.cl.DelegationBinding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DelegationBindingItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DelegationBinding_kind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DelegationBinding_kind_feature", "_UI_DelegationBinding_type"),
				 ClPackage.Literals.DELEGATION_BINDING__KIND,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		D_BindingKind labelValue = ((DelegationBinding)object).getKind();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DelegationBinding.class)) {
			case ClPackage.DELEGATION_BINDING__KIND:
