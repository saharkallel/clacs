...
public class FichierPortRequiredIntern
{
  protected static String nl;
  public static synchronized FichierPortRequiredIntern create(String lineSeparator)
  {
    nl = lineSeparator;
    FichierPortRequiredIntern result = new FichierPortRequiredIntern();
    nl = null;
    return result;
  }

  public final String NL = nl == null ? (System.getProperties().getProperty("line.separator")) : nl;
  protected final String TEXT_1 = "internalRequiredPorts:{";
...
ArrayList<Element> listPortsRequiredIntern = ((ArrayList<Element>)recup[1]);
    ...
    stringBuffer.append(listPortsRequiredIntern.get(i));
