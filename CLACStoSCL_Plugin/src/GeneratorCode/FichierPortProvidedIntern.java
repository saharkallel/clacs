...
public class FichierPortProvidedIntern
{
  protected static String nl;
  public static synchronized FichierPortProvidedIntern create(String lineSeparator)
  {
    nl = lineSeparator;
    FichierPortProvidedIntern result = new FichierPortProvidedIntern();
    nl = null;
    return result;
  }

  public final String NL = nl == null ? (System.getProperties().getProperty("line.separator")) : nl;
  protected final String TEXT_1 = "internalProvidedPorts:{";
...
ArrayList<Element> listPortsProvidedIntern = ((ArrayList<Element>)recup[1]);
    ...
    stringBuffer.append(listPortsProvidedIntern.get(i));
