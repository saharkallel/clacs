...
public class FichierPortProvided
{
  protected static String nl;
  public static synchronized FichierPortProvided create(String lineSeparator)
  {
    nl = lineSeparator;
    FichierPortProvided result = new FichierPortProvided();
    nl = null;
    return result;
  }

  public final String NL = nl == null ? (System.getProperties().getProperty("line.separator")) : nl;
  protected final String TEXT_1 = "providedPorts:{";
